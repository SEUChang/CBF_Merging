classdef Coordinator < matlab.DiscreteEventSystem & ...
    ...
    % The coordinator can communicate with the vehicles traveling inside the control zone and receive information from the environment.
    % Note that the coordinator is not involved in any decision making for any CAV and only enables communication of appropriate information among CAVs.
